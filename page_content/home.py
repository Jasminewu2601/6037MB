...
def home_page():
    ...
    left_col.markdown(
        ...
        <a href="mailto:1155220570@link.cuhk.edu.hk">1155220570@link.cuhk.edu.hk</a></p>
        """,
    ...
    st.markdown(
        """
        ### About Me
        I am a recent master's graduate in Marketing (big data) from the Chinese University of Hong Kong, eager to apply my knowledge and skills in a professional setting. During my academic journey, I developed a strong foundation in statistical analysis, machine learning, and data visualization.
